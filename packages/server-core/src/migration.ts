...
function parseCsv(text: string): { headers: string[]; rows: Record<string, string>[] } {
  ...
  const aliases: Record<string, string> = { "곡명": "title", "번호": "tjNumber", "아티스트": "artist", "원작": "originalWork", "장르": "country", "국가": "country", "추천인": "recommender", "키": "key", "생성 일시": "createdAt", "메모": "memo" };
